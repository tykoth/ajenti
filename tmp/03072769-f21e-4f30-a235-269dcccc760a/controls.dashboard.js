...
(function() {
  ...
  window.Controls.dashboard__dash = (function(superClass) {
    extend(dashboard__dash, superClass);
  ...
  window.Controls.dashboard__widget = (function(superClass) {
    extend(dashboard__widget, superClass);
  ...
  window.Controls.dashboard__header = (function(superClass) {
    extend(dashboard__header, superClass);
  ...
  window.Controls.dashboard__welcome = (function(superClass) {
    extend(dashboard__welcome, superClass);
